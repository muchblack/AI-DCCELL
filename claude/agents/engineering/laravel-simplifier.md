...
Host does NOT have PHP/Composer installed. ALL PHP commands MUST be executed via Podman:
...
- npm/Node.js: Run directly on host (`cd ~/code/php/{project} && npm {cmd}`)
- Database: MariaDB (NOT MySQL), use `DB_CONNECTION=mariadb` in Laravel 11+
